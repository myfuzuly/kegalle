...
$brandNames = array_values(array_unique([
    'Adidas','Asics','Avon','Babolat','Bauer','Black Diamond','Body Sculpture',
    'Bullpadel','CamelBak','Canterbury','Champion','Cosco','Decathlon','Diadora',
    'Dunlop','Everlast','Fitbit','Garmin','Gilbert','Head','Hummel','Joma','Kappa',
    'Kookaburra','Li-Ning','Macron','Mikasa','Molten','Nike','Nivia','NordicTrack',
    'Puma','Reebok','RDX','Skechers','Slazenger','Spalding','Speedo','Sportline',
    'Stag','Sunflex','Tarmak','The North Face','Titleist','Tunturi','Under Armour',
    'Wilson','Yonex',
]));

$cat = Category::where('name','like','%Sports%Accessories%')->whereNotNull('parent_id')->first();
if (!$cat) $cat = Category::where('name','like','%Sports%')->whereNotNull('parent_id')->first();
if (!$cat) $cat = Category::where('name','like','%Sports%')->first();
