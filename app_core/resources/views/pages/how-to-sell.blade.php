...
@section('content')
<section class="cats-hero"><div class="cats-hero-inner"><h1>How to Sell</h1><p>Post your first ad and start reaching local buyers today.</p></div></section>
<div class="container" style="padding-top:32px;padding-bottom:48px">
<div class="k-breadcrumb"><a href="/">Home</a><span class="sep">›</span><span class="current">How to Sell</span></div>
...
<div class="highlight-box"><h4>📸 Tip</h4><p>Listings with multiple clear photos and a detailed description get significantly more views and faster sales.</p></div>
