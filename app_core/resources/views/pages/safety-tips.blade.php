...
@section('content')
<section class="cats-hero"><div class="cats-hero-inner"><h1>Safety Tips</h1><p>Simple precautions to keep every transaction safe.</p></div></section>
<div class="container" style="padding-top:32px;padding-bottom:48px">
<div class="k-breadcrumb"><a href="/">Home</a><span class="sep">›</span><span class="current">Safety Tips</span></div>
...
<p>If you encounter a suspicious listing or user, use the "Report Ad" option on the listing page, or <a href="/contact-us">contact us</a> directly. We review every report.</p>
</div>
</div>
@endsection
